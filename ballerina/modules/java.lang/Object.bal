...
public distinct class Object {
    ...
    *java:JObject;
    ...
    public isolated function 'equals(Object arg0) returns boolean {
    ...
    public isolated function getClass() returns Class {
    ...
    public isolated function 'wait() returns InterruptedException? {
    ...
    # + return - The `InterruptedException` value returning from the Java mapping.
    public isolated function wait2(int arg0) returns InterruptedException? {
    ...
    # + return - The `InterruptedException` value returning from the Java mapping.
    public isolated function wait3(int arg0, int arg1) returns InterruptedException? {
...
public isolated function newObject1() returns Object {
    handle externalObj = java_lang_Object_newObject1();
    Object newObj = new (externalObj);
    return newObj;
}

isolated function java_lang_Object_equals(handle receiver, handle arg0) returns boolean = @java:Method {
    name: "equals",
    'class: "java.lang.Object",
    paramTypes: ["java.lang.Object"]
} external;

isolated function java_lang_Object_getClass(handle receiver) returns handle = @java:Method {
    name: "getClass",
    'class: "java.lang.Object",
    paramTypes: []
} external;

isolated function java_lang_Object_hashCode(handle receiver) returns int = @java:Method {
    name: "hashCode",
    'class: "java.lang.Object",
    paramTypes: []
} external;

isolated function java_lang_Object_notify(handle receiver) = @java:Method {
    name: "notify",
    'class: "java.lang.Object",
    paramTypes: []
} external;

isolated function java_lang_Object_notifyAll(handle receiver) = @java:Method {
    name: "notifyAll",
    'class: "java.lang.Object",
    paramTypes: []
} external;

isolated function java_lang_Object_wait(handle receiver) returns error? = @java:Method {
    name: "wait",
    'class: "java.lang.Object",
    paramTypes: []
} external;

isolated function java_lang_Object_wait2(handle receiver, int arg0) returns error? = @java:Method {
    name: "wait",
    'class: "java.lang.Object",
    paramTypes: ["long"]
} external;

isolated function java_lang_Object_wait3(handle receiver, int arg0, int arg1) returns error? = @java:Method {
    name: "wait",
    'class: "java.lang.Object",
    paramTypes: ["long", "int"]
} external;

isolated function java_lang_Object_newObject1() returns handle = @java:Constructor {
    'class: "java.lang.Object",
    paramTypes: []
} external;
