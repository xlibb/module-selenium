// This is an empty Ballerina class autogenerated to represent the `org.openqa.selenium.devtools.DevTools` Java class.
//
...
//               (<class-name>...)
//
// E.g. $ bal bindgen org.openqa.selenium.devtools.DevTools
